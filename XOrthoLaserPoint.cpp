...
//-----------------------------------------------------------------------------
// NO TRAJXOrthoLaserMesure* XOrthoLaserPoint::FindMesureOnSolution(ProjPostProcessSolution* sol)
//{
//	for (uint32 i = 0; i < m_Mesure.size(); i++)
...
//-----------------------------------------------------------------------------
// NO TRAJ bool XOrthoLaserPoint::ConnectSousEch(bool computeSegment)
//{
...
//}
//-----------------------------------------------------------------------------
// NO TRAJ void XOrthoLaserPoint::DeconnectSousEch(bool computeSegment)
//{
//	for (uint32 i = 0; i < m_Mesure.size(); i++)
...
bool XOrthoLaserPoint::XmlWrite(std::ostream* out)
{
	...
	*out << "<IsMovable> " << (int)IsMovable() << " </IsMovable>" << std::endl;
	if (m_bControl)
...
//-----------------------------------------------------------------------------
// NO TRAJ std::list<ProjPostProcessSolution*> XOrthoLaserPoint::listTrajecto()
//{
//	std::vector<XOrthoLaserMesure*> valid = MesuresValid();
...
//-----------------------------------------------------------------------------
// NO TRAJ XContrainte* XOrthoLaserPoint::CreateContrainte(XOrthoLaserMesure* mes)
//{
//	if(mes == NULL)
//	{
...
//}
//-----------------------------------------------------------------------------
// NO TRAJ std::vector<XContrainte*> XOrthoLaserPoint::CreateContraintes(ProjPostProcessSolution* sol)
//{
