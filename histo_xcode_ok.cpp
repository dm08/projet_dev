...
vector<vector<int>> find_non_zeros(vector<vector<double>> matrice_histo_max, int taille_vignette)
{
    vector<vector<int>> ligne_colonne;
...
int main(int argc, char** argv)
{
    ...
    vector<vector<int>> lc_nz = find_non_zeros(xy_max, taille_vignette);
